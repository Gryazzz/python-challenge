...
#filename = os.path.join('../PyBank/raw_data', 'budget_data_1.csv')
filename = '/Users/sonik/Desktop/BC/Homework/03-Python/Instructions/PyBank/raw_data/budget_data_1.csv'
newfile = '/Users/sonik/Desktop/BC/Homework/03-Python/Instructions/PyBank/raw_data/PyBankResults.txt'
